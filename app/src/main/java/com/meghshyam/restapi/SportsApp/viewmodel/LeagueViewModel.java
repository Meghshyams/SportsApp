...
public class LeagueViewModel extends BaseObservable {
    ...
    public LeagueViewModel(Context context){
    ...
    class MyTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected String doInBackground(Integer... params) {
            ...
            try {
                JSONObject response = getJSONObjectFromURL("https://www.thesportsdb.com/api/v1/json/1/search_all_leagues.php?s="+App.selectedSport); // calls method to get JSON object
                ...
                if(jsonArray.length()>0)
                {
                    for (int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        Log.w("onClick",""+App.selectedSport +"  ----  "+ jsonObject.getString("strSport"));
                                ...
                                dataModel.setIdSport(jsonObject.getString("idLeague"));
                                dataModel.setStrFormat(jsonObject.getString("strLeague"));
